 ...
 */
package com.sundydemo.learning1.java.utils.view;
...
import com.sundydemo.learning1.java.utils.video.TimeUtil;
...
public class PlayView {
     ...
     */
    public PlayView(
            Context context, OnPlayWindowListener onPlayWindowListener, OnWisePlayerListener onWisePlayerListener) {
            ...
            videoSizeTv.setText(
                    context.getResources()
                            .getString(
                                    ...
                                    wisePlayer.getVideoWidth(),
                                    wisePlayer.getVideoHeight()));
            videoTimeTv.setText(
                    context.getResources()
