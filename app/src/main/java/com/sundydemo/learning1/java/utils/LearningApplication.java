...
package com.sundydemo.learning1.java.utils;
...
import com.sundydemo.learning1.java.utils.network.NetworkConnectionCallbacks;
import com.sundydemo.learning1.java.utils.network.NetworkReceiver;
import com.sundydemo.learning1.java.utils.pushservice.PushUtil;
...
public class LearningApplication extends Application
   ...
   // CloudDbHelper cloudDbHelper;
    ...
    private void init() {
        ...
        //cloudDbHelper = CloudDbHelper.getInstance(this);  // commented by hq
    }
    ...
    private void initPlayer() {
        ...
        //WisePlayerFactoryOptionsExt factoryOptions = new WisePlayerFactoryOptions.Builder().setDeviceId("xxx").build();
        WisePlayerFactoryOptionsExt factoryOptions = new WisePlayerFactoryOptionsExt.Builder().setDeviceId("xxxsundydemotest").build();
        WisePlayerFactory.initFactory(this, factoryOptions, initFactoryCallback2);
    }

    /**
     * Player initialization callback
     */
    private static InitFactoryCallback initFactoryCallback2 =
            new InitFactoryCallback() {
                @Override
                public void onSuccess(WisePlayerFactory wisePlayerFactory) {

                    Log.d("test", "onSuccess wisePlayerFactory:" + wisePlayerFactory);
                    setWisePlayerFactory(wisePlayerFactory);
                }

                @Override
                public void onFailure(int errorCode, String reason) {
                    Log.d("test", "onSuccess wisePlayerFactory:" + errorCode);
                    //setWisePlayerFactory(wisePlayerFactory);
                }
            };
