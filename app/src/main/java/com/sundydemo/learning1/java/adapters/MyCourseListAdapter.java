...
public class MyCourseListAdapter extends RecyclerView.Adapter<MyCourseListAdapter.ViewHolder> {
    ...
    /**
     * Instantiates a new My course list adapter.
     *
     * @param listdata        the listdata
     * @param courseItemClick the course item click
     */
    public MyCourseListAdapter(List<CourseDataModel> listdata, CourseItemClick courseItemClick) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View listItem = layoutInflater.inflate(R.layout.mycourses_list_item, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.rating.setRating(myListData.getRatings());
