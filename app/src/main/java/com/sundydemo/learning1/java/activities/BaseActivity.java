...
import com.sundydemo.learning1.java.dialogs.LoginDialog;
 ...
 * Bug fix: commented the variant cloudDbHelper to fix video player issue. (line 55, 68)
 * @since 2021
 */
public abstract class BaseActivity extends AppCompatActivity {
     ...
     * The Cloud db helper.
     */
//    public CloudDbHelper cloudDbHelper;  by hq
    /**
     * The App analytics.
     */
...
// by hq        cloudDbHelper = ((LearningApplication) getApplicationContext()).getCloudDbHelper();
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == Constants.REQUEST_SIGN_IN_LOGIN_CODE) {
            ...
            if (authHuaweiIdTask.isSuccessful()) {
                AccountUtils.setUserInfo(authHuaweiIdTask.getResult(), CloudDbHelper.getInstance(getApplicationContext()), this);
