...
import com.sundydemo.learning1.java.activities.CourseDetailsActivity;
import com.sundydemo.learning1.java.activities.DocumentViewActivity;
import com.sundydemo.learning1.java.activities.HomeActivity;
import com.sundydemo.learning1.java.adapters.MainCourseListAdapter;
import com.sundydemo.learning1.java.adapters.SliderAdapter;
...
import com.sundydemo.learning1.databinding.FragmentHomeBinding;
import com.sundydemo.learning1.java.listeners.BannerItemClick;
import com.sundydemo.learning1.java.listeners.CourseItemClick;
import com.sundydemo.learning1.java.models.BannerModel;
import com.sundydemo.learning1.java.models.CourseDataModel;
import com.sundydemo.learning1.java.models.MainCoursesModel;
...
import static com.sundydemo.learning1.java.utils.video.Constants.SLIDER_DELAY;
...
public class HomeFragment extends Fragment {
     ...
     */
    @RequiresApi(api = Build.VERSION_CODES.N)
    public void setData(List<CoursesMainCategoryTable> mainCategories,
        ...
        if (!mainCategories.isEmpty() && !coDetailsList.isEmpty()) {
            ...
            if (recentlyViewedCoursesList.size() > 0) {
                ...
                /*if (courseDataModelList.size() > 0) {
                    mainCoursesModel = new MainCoursesModel(mainCategories.get(0) ///5)/
     ...
     */
// course item click
    CourseItemClick courseItemClick = new CourseItemClick() {
        @Override
        public void courseOnClick(CourseDataModel model) {
            ((BaseActivity) Objects.requireNonNull(getActivity()))
                    .appAnalytics.courseClickEvent(AnalyticsConstants.HOME_SCREEN, model.getName());
