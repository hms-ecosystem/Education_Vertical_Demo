...
import com.sundydemo.learning1.databinding.ActivitySplashScreenBinding;
...
//    // Callback handler used when the ad display timeout message is received.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CloudDbHelper.initAGConnectCloudDB(this);
        cloudDbHelper = CloudDbHelper.getInstance(this);//sundy 7/1
    ...
    private void queryUser(String uId) {
        if (uId != null) {
           ...
           /* CloudDBZoneQuery cloudDBZoneQuery = CloudDBZoneQuery.where(UsersInfoTable.class).equalTo("userId", uId);;
            cloudDbHelper.getCloudDbQueyCalls().queryUser(cloudDBZoneQuery, CloudDbAction.GET_USER);*/
            CloudDBZoneQuery cloudDBZoneQuery = CloudDBZoneQuery.where(UsersInfoTable.class);
            cloudDBZoneQuery.equalTo("userId", uId);
            cloudDbHelper
                    .getCloudDbQueyCalls()
