...
/**
 * Definition of ObjectType CourseContentTable.
 *
 * @since 2021-06-16
 */
@PrimaryKeys({"courseContentId"})
public final class CourseContentTable extends CloudDBZoneObject {
    ...
    public CourseContentTable() {
        super(CourseContentTable.class);
    }
