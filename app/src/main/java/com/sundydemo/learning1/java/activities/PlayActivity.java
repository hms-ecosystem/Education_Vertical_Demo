...
import com.sundydemo.learning1.java.adapters.TabsPagerAdapter;
...
import com.sundydemo.learning1.java.listeners.OnPlayWindowListener;
import com.sundydemo.learning1.java.listeners.OnWisePlayerListener;
import com.sundydemo.learning1.java.utils.AppUtils;
import com.sundydemo.learning1.java.utils.video.Constants;
import com.sundydemo.learning1.java.utils.video.DataFormatUtil;
import com.sundydemo.learning1.java.utils.video.DeviceUtil;
import com.sundydemo.learning1.java.utils.video.DialogUtil;
import com.sundydemo.learning1.java.utils.video.PlayControlUtil;
import com.sundydemo.learning1.java.utils.video.StringUtil;
import com.sundydemo.learning1.java.utils.video.control.PlayControl;
import com.sundydemo.learning1.java.utils.video.entity.PlayEntity;
import com.sundydemo.learning1.java.utils.view.PlayView;
...
public class PlayActivity extends BaseActivity implements OnPlayWindowListener,
   ...
   private CloudDbHelper cloudDbHelper; //added by hq
    ...
    protected void onResume() {
        super.onResume();
        isResume = true;
        Log.d("mymsg","onResume hasSurfaceCreated "+hasSurfaceCreated+" CurrentThread()"+ Thread.currentThread().getName());
    ...
    public void surfaceCreated(@NotNull SurfaceHolder holder) {
        ...
        Log.d("mymsg","surfaceCreated created");
...
// Set cycle mode
    ...
    public void onReady(final WisePlayer wisePlayer) {
        Log.d("mymsg","PlayActivity.onReady() wisePlayer: "+ wisePlayer.toString());

        playControl.start();
        isPlaying = true;
        Log.d("mymsg","onReady in "+ Thread.currentThread().getName());
        runOnUiThread(
                () -> {
